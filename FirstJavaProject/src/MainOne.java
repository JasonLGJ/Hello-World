...
class MyClassOne<T> implements Cloneable, Serializable {
    private int id = -1;
    private String name = "Unknown";
    public MyClassOne(int id, String name) {
        this.id = id;
        this.name = name;
    }
    public Object clone() {
    ...
    public String toString() {
        return "MyClassOne: id=" + this.id + ", name=" + this.name;
    }
}
...
public class MainOne {
    public static void main(String[] args) {
        ...
        String classDesciption = getClassDescription(MyClassOne.class);
    ...
    public static String getClassDescription(Class c) {
        ...
        String interfaces = MainOne.getClassInterfaces(c);
        if (interfaces != null) {
